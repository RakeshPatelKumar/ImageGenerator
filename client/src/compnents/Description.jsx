...
const Description = () => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex flex-col items-center justify-center py-24 px-6 md:px-28 w-full"
      style={{
        background: 'linear-gradient(to bottom, #111827, #1F2937, #111827)', // Dark gradient background
      }}
    >
      <h1 className="text-3xl sm:text-4xl text-white">Generate AI Images</h1>
      <p className="text-gray-400 mb-8">Bring Creative Vision to Life</p>
      ...
      <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center">
        ...
        <div className="text-white">
          ...
          <p className="text-gray-300 mb-4">
            ...
            even non-existent concepts come to life effortlessly. Unleash limitless 
